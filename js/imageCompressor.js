    ...
    var e,
        k = (function(e) {
            ...
            t = window, a = t.HTMLCanvasElement && t.HTMLCanvasElement.prototype, f = t.Blob && function() {
                ...
                for (r = t[2] ? t[1] : "text/plain" + (t[3] || ";charset=US-ASCII"), n = !!t[4], a = e.slice(t[0].length), i = n ? atob(a) : decodeURIComponent(a), o = new ArrayBuffer(i.length), l = new Uint8Array(o), u = 0; u < i.length; u += 1)
                    l[u] = i.charCodeAt(u);
                ...
                return M = c({}, t, M), f || (M.checkOrientation = !1), new Promise(function(r, e) {
                    if ((t = B) instanceof Blob || "[object Blob]" === o.call(t)) {
                        ...
                        if (A(n))
                            if (h || s) {
                                        ...
                                        r(i ? c({
                                            url: function(e, t) {
                                                ...
                                                if ("function" == typeof r.forEach)
                                                    ...
                                                    for (var a = r.length, i = 0; i < a; i += 1)
                                                        n += m(r[i]);
                                ...
                                e(new Error("The current browser does not support image compression."));
                        else
                            e(new Error("The first argument must be an image File or Blob object."))
                    } else
                        e(new Error("The first argument must be a File or Blob object."))
                }).then(function(r) {
                    ...
                    return new Promise(function(t) {
                        var e = document.createElement("canvas"),
                            ...
                            u = b,
                            c = w;
                        if (a < 1 / 0 && i < 1 / 0 ? a < i * n ? i = a / n : a = i * n : a < 1 / 0 ? i = a / n : i < 1 / 0 && (a = i * n), 0 < o && 0 < l ? o < l * n ? l = o / n : o = l * n : 0 < o ? l = o / n : 0 < l && (o = l * n), 0 < M.width)
                            c = (u = M.width) / n;
                        else if (0 < M.height) {
                            u = (c = M.height) * n
                        }
                    ...
                    if (h && !M.checkOrientation && h.revokeObjectURL(T.src), n)
                        if (n.size > B.size && M.mimeType === B.type && !(M.width > t || M.height > r || M.minWidth > t || M.minHeight > r))
                            n = B;
                        else {
                            var a = new Date;
